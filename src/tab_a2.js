...
var vuedata = {
  ...
  charts: {
    ...
    topRecipients: {
      ...
      info: 'Infografikā ir redzamas 10 politiskās partijas, kas ir saņēmušas vieslielākos ieņēmumus no biedru naudām izvēlētajā periodā.'
    },
    donationsPerYear: {
      title: 'Biedru nauda gadā',
      info: 'Infografikā ir redzams kopējais biedru naudas apjoms, kas ir saņemts no politiskajam partijām pa gadiem.'
    },
    topDonors: {
      title: 'Top 10 maksātāji',
      info: 'Infografikā ir redzami 10 politisko partiju biedri, kuri ir ziedojuši lielākās biedru naudas, izvēlētajā periodā.'
    },
    mainTable: {
      chart: null,
      type: 'table',
...
csv('./data/tab_a/a2.csv?' + randomPar, (err, finance) => {
