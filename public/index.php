    ...
    <div id="app" class="tabB">   
      ...
      <div class="container-fluid dashboard-container-outer">
        <div class="row dashboard-container">
            ...
            <div class="row">
              ...
              <div class="col-lg-8 chart-col">
                <div class="boxed-container description-container">
                  <h1>Deputāti uz Delnas</h1>
                  <p>Šī lietotājam draudzīgā datubāze sniedz pārskatu par šobrīd amatā esošiem Saeimas deputātiem. Zemāk redzamajā uzskaitījumā izvēloties konkrētu personu, iespējams iegūt sīkāku informāciju par deputātu, maksājumiem politiskajām partijām un ārējām interesēm.</p>
                </div>
              </div>
          ...
          <div class="col-md-3 chart-col">
            <div class="boxed-container chart-container tab_b_3">
              <chart-header :title="charts.status.title" :info="charts.status.info" ></chart-header>
              <div class="chart-inner" id="status_chart"></div>
            </div>
          </div>
          <!-- TABLE -->
                        ...
                        <div class="col-md-12 mp-profile-section-inner">
                          ...
                          <div v-if="selectedElement.declarations">
                            <div v-for="year in selectedElement.declarations.years" class="mp-profile-year-container">
                              ...
                              <div class="details-line details-line-nopadding"><span class="details-line-title">Deklarācijas gāds: </span> {{ year }}</div>
                              <div class="details-line details-line-nopadding"><span class="details-line-title">Deklarācija izsniegta kā: </span> {{ selectedElement.declarations[year][0]["filed_as"] }}</div>
                              <div class="details-line details-line-nopadding"><span class="details-line-title">Saeimas komisijas deklarācijas gadā: </span> {{ selectedElement.declarations[year][0]["Committees"] }}</div>
                              <!-- Interests table 1 -->
